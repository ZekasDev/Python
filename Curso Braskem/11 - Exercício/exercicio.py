...
O código acima informa se o número inteiro informado pelo usuário 
(e armazenado na variável x) é positivo ou negativo e par ou ímpar. 
...
sendo possível devido às estruturas de repetição. 
Em Python, uma dessas estruturas é o laço while
que determina que um bloco de código seja repetido enquanto uma dada condição
for verdadeira. Observe o código a seguir:
...
# Resposta: A soma dos 999 casos, onde os primeiros termos da série serão [1, 1/2, 1/4, 1/8, ...]


# Questão 03

'''
Além do laço de repetição while, muitas vezes utilizamos o operador for 
em Python para implementarmos laços de repetição. Embora isso seja possível
o for é mais do que meramente um laço de repetição: 
este operador é utilizado para percorrer alguma estrutura iterável.

for _ in range(10):
    print("Olá, mundo!") 

Quando queremos utilizar o for explicitamente como um laço de repetição,
é muito comum utilizarmos a estrutura acima, com o auxílio do iterador range()
No entanto, o mesmo comportamento é possível se nos aproveitarmos do fato 
de que o for percorre qualquer iterável. 
Sabendo disso, das alternativas a seguir
qual é a única que NÃO reproduz o mesmo resultado que o trecho acima?
'''

# Resposta: for _ in "let's code":
#                        print("Olá, mundo!")
...
para que o código acima gere a seguinte 
...
Observe o código abaixo e o respectivo output desejado:
